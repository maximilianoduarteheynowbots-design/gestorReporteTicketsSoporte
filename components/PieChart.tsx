...
export const PieChart: React.FC<PieChartProps> = ({ data, size = 250, vertical = false }) => {
    ...
    return (
        <div className={`flex flex-col ${vertical ? '' : 'md:flex-row'} items-center justify-center gap-6`}>
            ...
            <div 
                className={`flex ${vertical ? 'flex-col gap-y-2 w-full max-w-[200px]' : 'flex-wrap justify-center gap-x-4 gap-y-2'}`} 
